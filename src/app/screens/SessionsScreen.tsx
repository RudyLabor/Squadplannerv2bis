      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <div className="grid grid-cols-3 gap-3">
            <StatCard value={sessions.length} label="Total" icon={CalendarDays} accentColor="#f5a623" />
            <StatCard value={todayCount} label="Aujourd'hui" icon={Clock} accentColor="#60a5fa" />
            <StatCard value={confirmedCount} label="Confirmées" icon={Check} accentColor="#4ade80" />
          </div>
